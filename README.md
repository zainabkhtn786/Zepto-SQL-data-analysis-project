...
a) sku_id – Unique product identifier
...
e) discountPercent – Discount offered

f) discountedSellingPrice – Final selling price

g) availableQuantity – Inventory available

h) outOfStock – Stock availability flag

i) weightInGms – Product weight

j) quantity – Unit quantity
